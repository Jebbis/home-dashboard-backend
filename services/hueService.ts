...
export async function fetchLightState(lightId: string) {
...
export async function toggleLightState(lightId: string) {
...
export async function toggleLightBrightness(lightId: string, value: number) {
